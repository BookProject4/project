			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-8 col-md-7 col-12">
						<form method="post" action="../search/search.do" id="searchFrm"
							name="searchFrm">
							<div class="search-bar-top">
								<div class="search-bar">
									...
									</select> <input name="search" id="search" name="search"
										placeholder="검색어를 입력하세요!">
									<button class="btnn" id="sendBtn" name="sendBtn">
										<i class="ti-search"></i>
									</button>
								</div>
							</div>
					...
					<div class="col-lg-2 col-md-3 col-12">
						<div class="right-bar">
							...
							<div class="sinlge-bar">
								<a href="../mypage/mypage.do" class="single-icon"><i
								...
								<div class="shopping-item">
									...
									<ul class="shopping-list">
										...
										<li><a href="#" class="remove" title="Remove this item"><i
											...
											<p class="quantity">
												1x - <span class="amount">12,000원</span>
											</p></li>
										<li><a href="#" class="remove" title="Remove this item"><i
												class="fa fa-remove"></i></a> <a class="cart-img" href="#"><img
												src="https://via.placeholder.com/70x70" alt="#"></a>
									...
									<div class="bottom">
										<div class="total">
											<span>Total</span> <span class="total-amount">45,000원</span>
										</div>
