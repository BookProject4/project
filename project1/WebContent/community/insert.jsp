...
<div class="wrapper row3">
  ...
  <form method=post action="../community/insert_ok.do" enctype="multipart/form-data">
    <table class="table">
      <tr>
      ...
      <tr>
        <th width="20%" class="text-right">파일</th>
		<td width="80%"><input type=file size=20 name=upload class="input-sm"></td>
	  </tr>
      <tr>
